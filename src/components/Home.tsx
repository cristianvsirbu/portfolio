  ...
  return (
    <div className="flex flex-col flex-grow items-center justify-center w-full">
      <h1 className="text-7xl leading-none text-white font-medium">
        Hi, I’m <GradientText className='font-inter-heavy'>Cristian Sîrbu</GradientText>
      </h1>
      <h1 className="text-6xl text-white font-medium">
        I bring <span className='font-jersey text-primary'>pixels</span> to life with <span className='font-geist-mono text-secondary'>code</span>
      </h1>
